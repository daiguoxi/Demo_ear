...
def densenet121(pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        memory_efficient (bool) - If True, uses checkpointing. Much more memory efficient,
          but slower. Default: *False*. See `"paper" <https://arxiv.org/pdf/1707.06990.pdf>`_
    """
    return _densenet('densenet121', 32, (6, 6, 12, 24, 16), 64, pretrained, progress,
                     **kwargs)
...
def densenet161(pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        memory_efficient (bool) - If True, uses checkpointing. Much more memory efficient,
          but slower. Default: *False*. See `"paper" <https://arxiv.org/pdf/1707.06990.pdf>`_
    """
    return _densenet('densenet161', 48, (6, 6, 12, 36, 24), 96, pretrained, progress,
                     **kwargs)
...
def densenet169(pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        memory_efficient (bool) - If True, uses checkpointing. Much more memory efficient,
          but slower. Default: *False*. See `"paper" <https://arxiv.org/pdf/1707.06990.pdf>`_
    """
    return _densenet('densenet169', 32, (6, 6, 12, 32, 32), 64, pretrained, progress,
                     **kwargs)
...
def densenet201(pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        memory_efficient (bool) - If True, uses checkpointing. Much more memory efficient,
          but slower. Default: *False*. See `"paper" <https://arxiv.org/pdf/1707.06990.pdf>`_
    """
    return _densenet('densenet201', 32, (6, 6, 12, 48, 32), 64, pretrained, progress,
                     **kwargs)
...
if __name__ == "__main__":
    dense121 = densenet121(pretrained=False,progress=True)
    print(dense121)
